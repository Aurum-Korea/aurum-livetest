...
// ── Advisor setup / welcome email ─────────────────────────────────────────────
export function buildAdvisorSetupEmail({ advisor, setupUrl, siteUrl }) {
  const subject = `Your Aurum GP Advisor Portal — set up access`;
  const text = [
    `Hello ${advisor.name},`,
    ``,
    `Your GP advisor account has been created on the Aurum Century Club portal.`,
    ``,
    `Set up your password using the link below:`,
    `${setupUrl}`,
    ``,
    `This link expires in 7 days and works once.`,
    `After setup, sign in at: ${siteUrl}/login?r=advisor`,
    ``,
    `— The Partners, Aurum Century Club`,
  ].join('\n');
...
<tr><td style="background:#0a0a0a;padding:0 0 24px"><span style="font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.34em;color:#C5A572;text-transform:uppercase">GP ADVISOR PORTAL</span></td></tr>
<tr><td style="background:#0a0a0a;padding:0 0 20px;font-family:Georgia,serif;font-size:28px;font-weight:500;color:#e8e3d8">Welcome, <em style="font-style:italic;color:#C5A572">${advisor.name}.</em></td></tr>
<tr><td style="background:#0a0a0a;padding:0 0 18px;font-family:Georgia,serif;font-size:15px;line-height:1.7;color:#aaa39a">Your GP advisor account has been created. Set up your password to access the deal pipeline.</td></tr>
<tr><td style="background:#0a0a0a;padding:0 0 8px;font-family:'JetBrains Mono',monospace;font-size:8px;letter-spacing:.24em;color:#8a7d6b;text-transform:uppercase">Firm</td></tr>
<tr><td style="background:#0a0a0a;padding:0 0 24px;font-family:Georgia,serif;font-size:14px;color:#e8e3d8">${advisor.firm}</td></tr>
<tr><td style="background:#0a0a0a;padding:0 0 28px"><a href="${setupUrl}" style="display:inline-block;padding:14px 26px;background:#C5A572;color:#0a0a0a;text-decoration:none;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.28em;text-transform:uppercase;font-weight:600">SET UP ACCESS →</a></td></tr>
<tr><td style="background:#0a0a0a;padding:0 0 28px;font-family:Georgia,serif;font-style:italic;font-size:12px;color:#6b655e">This link expires in 7 days and works once. After setup, sign in at /login.</td></tr>
<tr><td style="background:#0a0a0a;border-top:1px solid rgba(255,255,255,0.07);padding:20px 0 0;font-family:'JetBrains Mono',monospace;font-size:8px;letter-spacing:.26em;color:#6b655e;text-transform:uppercase">AURUM CENTURY CLUB · CONFIDENTIAL</td></tr>
