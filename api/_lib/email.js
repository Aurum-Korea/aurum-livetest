...
<!doctype html><html><body style="margin:0;padding:0;background:#0a0a0a;color:#e8e3d8;font-family:Georgia,serif">
  <div style="max-width:560px;margin:0 auto;padding:32px 28px">
    <div style="border:1px solid rgba(197,165,114,0.4);padding:5px 10px;display:inline-block;color:#C5A572;font-style:italic;font-family:Georgia,serif;font-size:14px">Au</div>
    <div style="font:11px 'JetBrains Mono',ui-monospace,monospace;letter-spacing:.32em;color:#C5A572;margin:18px 0 4px">NEW INQUIRY</div>
...
export function buildInvitationEmail({ lead, code, accessUrl }) {
  ...
  const text = [
    ...
    ``,
    `Or visit ${brand()}/code and enter the code above. The materials include the`,
    `Founders Memo, the Companion Memo, and the Patron FAQ. Treated under the standing NDA`,
    `acknowledged in your inquiry.`,
    ``,
    ...
    ``,
    `아우럼 센추리 클럽에 관심을 가져 주셔서 감사합니다. 검토를 거쳐 전체 투자 메모와`,
    ...
    `자료 열람:  ${accessUrl}`,
    ``,
    `또는 ${brand()}/code 페이지에서 위 코드를 입력하시면 됩니다. 자료에는 창립 회원`,
    `메모, 보조 메모, 회원 FAQ가 포함되어 있으며, 문의 시 동의하신 비밀유지 원칙 하에 제공됩니다.`,
    ``,
...
<!doctype html><html><body style="margin:0;padding:0;background:#0a0a0a;color:#e8e3d8;font-family:'Cormorant Garamond',Georgia,serif">
  <div style="max-width:600px;margin:0 auto;padding:48px 32px">
    <div style="border:1px solid #C5A572;padding:8px 14px;display:inline-block;color:#C5A572;font-style:italic;font-family:Georgia,serif;font-size:18px;letter-spacing:-0.04em">Au</div>
    ...
    <p style="font-family:Georgia,serif;font-size:14.5px;line-height:1.78;color:#aaa39a;margin:0 0 20px">
      Or visit <a href="${brand()}/code" style="color:#E3C187;text-decoration:none;border-bottom:1px solid rgba(197,165,114,0.3)">${escape(brand().replace(/^https?:\/\//, ''))}/code</a> and enter the code above. The materials include the <em>Founders Memo</em>, the <em>Companion Memo</em>, and the <em>Patron FAQ</em> — treated under the standing NDA you acknowledged in your inquiry.
    </p>
    ...
    <p style="font-family:'Noto Serif KR',Georgia,serif;font-size:14px;line-height:1.85;color:#aaa39a;margin:0 0 18px">
      아우럼 센추리 클럽에 관심을 가져 주셔서 감사합니다. 파트너 검토를 거쳐 <em style="color:#E3C187">전체 투자 메모</em>와 두 개시 포지션 열람 권한을 부여해 드립니다.
    </p>
    <p style="font-family:'Noto Serif KR',Georgia,serif;font-size:14px;line-height:1.85;color:#aaa39a;margin:0 0 24px">
      위의 초대 코드를 사용하시거나 <a href="${accessUrl}" style="color:#E3C187;text-decoration:none">자료 열람</a> 링크를 클릭해 주세요. 창립 회원 메모, 보조 메모, 회원 FAQ가 포함되며, 문의 시 동의하신 비밀유지 원칙 하에 제공됩니다.
    </p>
