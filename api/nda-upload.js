// POST /api/nda-upload — patron uploads their signed NDA.
...
import { ok, bad, unauthorized, methodNotAllowed, readBody, getCookie, json } from './_lib/http.js';
...
export default async function handler(req, res) {
  ...
  // This array is append-only and grows whenever a patron re-uploads
  ...
  lead.audit.push({
    at: now, actor: 'patron', action: 'nda_uploaded',
