...
function LaunchAnnouncementStrip({ navigate }) {
  ...
  const messages = [
    { label: 'AGP 자동 적금 · 지금 가입 시 첫달 즉시 적립', cta: 'AGP 시작하기 →', page: 'agp-intro' },
  ...
  return (
    <div style={{ height: 40, background: 'linear-gradient(90deg,#1a1508,#2a1f0a,#1a1508)', borderBottom: '1px solid rgba(197,165,114,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16, position: 'relative', flexShrink: 0, zIndex: 101 }}>
      ...
      <button onClick={() => navigate(m.page)} style={{ background: 'rgba(197,165,114,0.15)', border: '1px solid rgba(197,165,114,0.5)', color: '#c5a572', padding: '3px 12px', fontSize: 11, fontFamily: "'Outfit',sans-serif", fontWeight: 700, cursor: 'pointer', letterSpacing: '0.04em' }}>{m.cta}</button>
...
export default function App() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <div style={{ position: 'sticky', top: 'calc(112px + env(safe-area-inset-top, 0px))', zIndex: 99 }}>
