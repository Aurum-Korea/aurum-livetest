    ...
    <div style={{ background: T.bg, minHeight: '85vh' }}>
      <div className="aurum-container" style={{ paddingTop: isMobile ? 48 : 80, paddingBottom: isMobile ? 48 : 80 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2,1fr)', gap: 24 }}>
          ...
          {/* GoldPath card */}
          <div style={{ width: isMobile ? 48 : 72, height: isMobile ? 48 : 72, border: `1px solid ${T.goldBorderStrong}`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginBottom: isMobile ? 20 : 32, gap: 2 }}>
            <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: isMobile ? 11 : 13, color: T.gold }}>› GP</span>
            <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: isMobile ? 7 : 8, color: '#7a6d58', letterSpacing: '0.18em' }}>금환</span>
          </div>
            <h2 style={{ fontFamily: T.serifKr, fontSize: isMobile ? 22 : 28, fontWeight: 600, color: T.text, marginBottom: 16, lineHeight: 1.2 }}>{ko ? 'GoldPath 금환' : 'GoldPath'}</h2>
            <p style={{ color: T.textSub, fontSize: 14, lineHeight: 1.8, marginBottom: 24, fontFamily: T.sans, flex: 1 }}>
            ...
            <div style={{ marginTop: 'auto', paddingTop: 14, borderTop: `1px solid rgba(197,165,114,0.3)`, display: 'flex', justifyContent: 'space-between', fontFamily: T.mono, fontSize: 12, letterSpacing: '0.15em', color: T.gold, textTransform: 'uppercase' }}>
              <span>{ko ? 'GoldPath 시작하기' : 'Start GoldPath'}</span><span>→</span>
            </div>
          </div>
        </div>
