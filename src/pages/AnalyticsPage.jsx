    ...
    <Panel num="I" title={ko ? '시장 현황' : 'Market Strip'} sub={ko ? '실시간 · London Fix' : 'Live · London Fix'} live>
      <div className="ms-grid" style={{
        ...
        <div style={{ background: T.bg || '#0a0a0a', border: `1px solid ${T.border}`, padding: 16, display: 'flex', flexDirection: 'column', minHeight: 380 }}>
          ...
          <div ref={containerRef} style={{ width: '100%', flex: 1, minHeight: 260 }} />
        </div>
      ...
      <p style={{ fontFamily: T.serifKr, fontSize: 13, color: T.sub, lineHeight: 1.85, marginTop: 18, maxWidth: 720 }}>
        {ko
