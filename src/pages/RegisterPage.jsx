        ...
        {step === 1 && (
          <div>
            ...
            <p style={{ fontFamily: T.sans, fontSize: 14, color: T.textSub, lineHeight: 1.8, marginBottom: 28, maxWidth: 460 }}>
              {ko
                ? 'Founders Club 멤버는 실물 구매 및 AGP 적립 시 거래 누적(GMV)에 따라 자동으로 할인이 적용됩니다. 한 번 열린 게이트는 닫히지 않습니다.'
                : 'Founders Club members get automatic lifetime discounts on physical purchases and AGP savings, scaling with your total transaction volume. Gates never close once opened.'}
            </p>
        ...
        {step === 4 && (
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 24 }}>
              {[
                { icon: '⚖️', title: ko ? 'AGP 적금 설정' : 'Set up AGP savings', sub: ko ? '월 20만원부터 그램 단위 자동 적립' : 'Auto-accumulate from ₩200K/month', route: 'agp-enroll' },
