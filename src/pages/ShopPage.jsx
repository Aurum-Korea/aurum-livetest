...
function GoldCoinSVG({ purity }) {
  return (
    <svg viewBox="0 0 400 200" width="100%" height="100%" className="product-svg" style={{ display: 'block' }}>
      ...
      {/* Center motif */}
      <text x="200" y="112" textAnchor="middle" fontFamily="'Cormorant Garamond', Georgia, serif" fontStyle="italic" fontWeight="600" fontSize="58" fill="rgba(40,26,12,0.82)" letterSpacing="-0.02em">A</text>
      {/* Purity arc top */}
...
function SilverCoinSVG({ purity }) {
  return (
    <svg viewBox="0 0 400 200" width="100%" height="100%" className="product-svg" style={{ display: 'block' }}>
      ...
      <text x="200" y="112" textAnchor="middle" fontFamily="'Cormorant Garamond', Georgia, serif" fontStyle="italic" fontWeight="600" fontSize="58" fill="rgba(30,30,36,0.82)" letterSpacing="-0.02em">A</text>
