  ...
  return (
    <section style={{ padding: '56px 20px 80px', position: 'relative', overflow: 'hidden', borderBottom: `1px solid ${T.border}` }}>
      ...
      <div style={{
        ...
        color: 'rgba(197,165,114,0.022)', letterSpacing: '-0.05em',
          ...
          <div style={{ position: 'relative', width: 'min(340px, 88vw)', height: 'min(340px, 88vw)', maxWidth: '90vw', maxHeight: '90vw' }}>
            <div style={{
              ...
              <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#2a1f10' }}>
                <div style={{ fontFamily: T.serif, fontStyle: 'italic', fontSize: 86, fontWeight: 600, lineHeight: 0.88, letterSpacing: '-0.02em' }}>Aurum</div>
                <div style={{ fontFamily: T.mono, fontSize: 10, letterSpacing: '0.4em', fontWeight: 700, marginTop: 6 }}>999.9 · 1g</div>
                <div style={{ fontFamily: T.mono, fontSize: 7, letterSpacing: '0.34em', marginTop: 46, opacity: 0.65 }}>#{'2848'} · MMXXVI · SGP</div>
              </div>
            </div>
            {/* Orbiting label */}
    ...
    <div style={{ background: T.card, border: `1px solid ${T.goldBorder}`, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ padding: 18 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 3, height: 50, marginBottom: 14 }}>
          {data.map((d, i) => {
            const h = (d.t / max) * 100;
            return <div key={i} style={{ flex: 1, background: d.hi ? T.gold : 'rgba(197,165,114,0.3)', height: `${h}%` }} />;
          })}
        </div>
        <div style={{ fontFamily: T.sansKr, fontSize: 12, color: T.sub, lineHeight: 1.65, borderLeft: `2px solid ${T.gold}`, paddingLeft: 10 }}>
  ...
  return (
    <div style={{ background: T.card, border: `1px solid ${T.goldBorder}`, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '14px 18px', borderBottom: `1px solid ${T.border}` }}>
        ...
        <div style={{ fontFamily: T.serif, fontStyle: 'italic', fontSize: 11, color: T.goldD, marginTop: 3 }}>What ₩100,000 does today</div>
      </div>
      <div style={{ padding: 18 }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 16 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 14 }}>
          <div>
            <div style={{ fontFamily: T.mono, fontSize: 9, color: T.muted, letterSpacing: '0.14em', marginBottom: 3 }}>2000 · ₩100,000</div>
            <div style={{ height: 8, background: `linear-gradient(90deg, ${T.goldD}, ${T.gold})`, width: '100%' }} />
          </div>
          <div>
            <div style={{ fontFamily: T.mono, fontSize: 9, color: T.muted, letterSpacing: '0.14em', marginBottom: 3 }}>2026 · ₩47,000 (equivalent)</div>
...
function DropTierGrid() {
  ...
  return (
    <section style={{ padding: '80px 20px', borderBottom: `1px solid ${T.border}` }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 28, flexWrap: 'wrap', gap: 18 }}>
          <div>
            <div style={{ fontFamily: T.mono, fontSize: 10, color: T.gold, letterSpacing: '0.3em', marginBottom: 12 }}>IV · DROP · 5,000 CAP</div>
            <h2 style={{ fontFamily: T.serifKr, fontSize: 'clamp(36px, 5.5vw, 68px)', fontWeight: 700, color: T.text, lineHeight: 1, letterSpacing: '-0.03em', margin: 0 }}>
              5,000명. <em style={{ fontFamily: T.serif, fontStyle: 'italic', color: T.gold, fontWeight: 500 }}>그다음은 없다.</em>
            </h2>
          </div>
          <div style={{ fontFamily: T.mono, fontSize: 13, color: T.goldD, letterSpacing: '0.22em' }}>2,848 / 5,000</div>
        </div>

        <div style={{ background: T.card, border: `1px solid ${T.goldBorder}`, overflow: 'hidden' }}>
          <div style={{ height: 3, background: 'rgba(255,255,255,0.06)' }}>
            <div style={{ width: '57%', height: '100%', background: `linear-gradient(90deg, ${T.goldB}, ${T.gold})`, boxShadow: `0 0 12px ${T.goldGlow}` }} />
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px, 1fr))', gap: 0 }}>
            {tiers.map((t, i) => (
              <div key={i} style={{
                ...
                <div style={{ fontFamily: T.serif, fontStyle: 'italic', fontSize: 46, color: t.feat ? T.goldB : T.gold, fontWeight: 500, lineHeight: 1, marginTop: t.feat ? 14 : 0 }}>{t.n}</div>
                ...
                <div style={{ fontFamily: T.serif, fontStyle: 'italic', fontSize: 26, color: t.feat ? T.goldB : T.gold, fontWeight: 600, marginTop: 3 }}>{t.gift}</div>
        ...
        {/* CAP EXPLAINER LINE — Agent 01 directive, answering Q2 decision */}
        <div style={{ marginTop: 18, padding: '10px 14px', background: T.deepBlack, border: `1px dashed ${T.goldBorder}`, fontFamily: T.sansKr, fontSize: 11, color: T.muted, lineHeight: 1.6 }}>
          <span style={{ color: T.goldD, fontFamily: T.mono, letterSpacing: '0.18em', marginRight: 8 }}>※ GOLDPATH 금환 · 5,000 CAP</span>
          이 드롭은 GoldPath 금환의 AGP Founding Cohort 한정 5,000명입니다. 별도의 Founders 프로그램(500명 한정, 초대 중심)은 <span style={{ color: T.gold }}>/founders</span>에서 확인하세요.
        </div>
      </div>
    </section>
  );
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 }}>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <div style={{ fontFamily: T.serif, fontStyle: 'italic', fontSize: 44, fontWeight: 600, lineHeight: 1 }}>Aurum</div>
              <div style={{ fontFamily: T.mono, fontSize: 9, letterSpacing: '0.2em', marginTop: 4 }}>999.9 · #2848 · MMXXVI</div>
            </div>
            <button style={{ background: '#1a1610', color: T.gold, padding: '10px 16px', fontSize: 11, fontWeight: 700, fontFamily: T.sans, letterSpacing: '0.1em', alignSelf: 'flex-start' }}>
              SHARE ↗
            </button>
          </div>
        </div>
