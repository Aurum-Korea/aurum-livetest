...
function QuietDoor() {
  return (
    <>
      ...
      {/* II · The Phrase */}
      <div style={{ padding: '60px 24px 120px', textAlign: 'center', maxWidth: 900, margin: '0 auto' }}>
        <div style={{ fontFamily: T.serifKr, fontSize: 'clamp(32px, 6vw, 56px)', fontWeight: 400, color: T.text, lineHeight: 1.35, marginBottom: 18, letterSpacing: '-0.005em' }}>
          조용하게 쌓인다.
        </div>
        <div style={{ fontFamily: T.serifKr, fontSize: 'clamp(32px, 6vw, 56px)', fontWeight: 400, color: T.text, lineHeight: 1.35, marginBottom: 32, letterSpacing: '-0.005em' }}>
          영원히 남는다.
        </div>
        <div style={{ fontFamily: T.serif, fontStyle: 'italic', fontSize: 'clamp(18px, 3vw, 26px)', color: T.goldD, fontWeight: 300, lineHeight: 1.5 }}>
...
function HybridHero() {
  ...
  const priceRefs = [{ lbl: 'KOREA RETAIL', val: '₩186,800', note: '+VAT 10%', color: T.red, tone: 'dn' },
                     ...
                     { lbl: 'FOUNDERS III', val: '₩152,560', note: '−18.4%', color: T.green, tone: 'up' }];
  useEffect(() => {
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16, marginBottom: 16 }}>
            ...
            <div style={{ background: `linear-gradient(135deg, ${T.goldB}, ${T.gold} 60%, ${T.goldDeep})`, padding: 22, color: '#1a1610', position: 'relative', overflow: 'hidden', aspectRatio: '1 / 1', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                ...
                <div style={{ fontFamily: T.serif, fontStyle: 'italic', fontSize: 40, fontWeight: 600, lineHeight: 1 }}>Aurum</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 }}>
            ...
            <div style={{ background: `linear-gradient(135deg, ${T.goldB}, ${T.gold} 60%, ${T.goldDeep})`, padding: 22, color: '#1a1610', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', minHeight: 280 }}>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                ...
                <div style={{ fontFamily: T.serif, fontStyle: 'italic', fontSize: 36, fontWeight: 600, lineHeight: 1 }}>Aurum</div>
              </div>
