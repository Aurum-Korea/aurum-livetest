        ...
        {!isMobile && (
          <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', gap: 12 }}>
            {links.filter(l => l.isFounders || l.isMain).map(l => {
              ...
              if (l.isMain) {
                // GoldPath — compact terminal mark: › GoldPath▌ + 금환
                return (
                  <button key={l.page} onClick={() => navigate(l.page)}
                    className={`goldpath-btn${isActive ? ' active-goldpath' : ''}`}
                    style={{ ...btnBase, padding: '0 28px', borderRadius: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 3 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 2, lineHeight: 1 }}>
                      <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 14, color: '#C5A572', lineHeight: 1 }}>›</span>
                      <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 14, color: isActive ? '#f5f0e8' : '#E3C187', lineHeight: 1, letterSpacing: '0.03em' }}>GoldPath</span>
                      <span className="gp-nav-cur" style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 14, color: '#C5A572', lineHeight: 1 }}>▌</span>
                    </div>
                    <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 10, color: isActive ? 'rgba(197,165,114,0.9)' : '#7a6d58', letterSpacing: '0.22em', lineHeight: 1, whiteSpace: 'nowrap' }}>금환</span>
                  </button>
                );
              }
              return (
