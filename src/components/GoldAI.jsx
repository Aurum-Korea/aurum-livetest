  ...
  const MENU_ITEMS = [
    {
      ...
      sub:   ko ? '금 가격·절감액·GoldPath 질문' : 'Ask about gold, savings, GoldPath',
      color: gold,
      action: () => setMode('chat'),
    },
    {
            ...
            {msgs.length === 0 && (
              <div style={{ marginTop:8 }}>
                <p style={{ fontFamily:SANS, fontSize:13, color:'#a0a0a0', lineHeight:1.7, marginBottom:14 }}>
                  {ko ? '금 시세, 한국 대비 절감액, GoldPath, Founders Gate에 대해 질문하세요.' : 'Ask about gold prices, Korea savings, GoldPath, or Founders Gates.'}
                </p>
