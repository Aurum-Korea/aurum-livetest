...
export default function Ticker({ lang, prices, krwRate, dailyChanges, loaded }) {
  ...
  const TickerItem = ({ item }) => (
    ...
    onMouseLeave={e => e.currentTarget.style.opacity = '1'}>
      {/* Issue 4: label font-size 12px */}
      <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 12, color: '#8a7d6b', letterSpacing: '0.14em', textTransform: 'uppercase' }}>{item.label}</span>
      {!loaded
