...
export default function PromoBar({
  ...
  return (
    <div style={{
      background: 'linear-gradient(90deg, #0a0806, #0d0a06 50%, #0a0806)',
      ...
      <div className="aurum-promo-inner" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          ...
          <span className="aurum-promo-label-full" style={{
            color: T.gold, letterSpacing: '0.24em', fontWeight: 700, fontSize: 10,
            whiteSpace: 'nowrap',
          }}>
            {label}
          </span>
          <span className="aurum-promo-label-short" style={{
            color: T.gold, letterSpacing: '0.18em', fontWeight: 700, fontSize: 10,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, color: T.text }}>
          <span className="aurum-promo-desktop-only" style={{
            color: T.goldD, letterSpacing: '0.22em', fontSize: 9, whiteSpace: 'nowrap',
          }}>
            ENDS IN
          </span>
          {[[t.d, 'D'], [t.h, 'H'], [t.m, 'M'], [t.s, 'S']].map(([v, l], i) => (
            ...
            >
              <span style={{
                fontSize: 13, fontWeight: 700, color: T.goldB,
