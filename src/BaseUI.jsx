...
// A-STRUCT: Import premium constants from single source of truth (lib/index.jsx)
// Do NOT redefine these here — BaseUI previously had duplicates that could drift
import { KR_GOLD_PREMIUM, KR_SILVER_PREMIUM, AURUM_GOLD_PREMIUM, AURUM_SILVER_PREMIUM } from "./lib/index.jsx";
export { KR_GOLD_PREMIUM, KR_SILVER_PREMIUM, AURUM_GOLD_PREMIUM, AURUM_SILVER_PREMIUM };
...
function Ticker({ lang, prices, krwRate, dailyChanges }) {
  ...
  useEffect(() => {
    ...
    setItems([
      ...
      { label: lang==='ko' ? '국내 현물가 1돈 기준' : 'KR Gold/돈',
...
function Nav({ page, navigate, lang, setLang, user, setUser, setShowLogin, cart }) {
  ...
  const mainLinks = [
    ...
    { key:"campaign-agp-launch",  ko:"GoldPath 론치", en:"GoldPath Launch",    dot:true },
    { key:"shop",                 ko:"매장",           en:"Shop"  },
    { key:"why",                  ko:"왜 금인가",      en:"Why Gold" },
    { key:"storage",              ko:"보관",           en:"Storage" },
    { key:"agp",                  ko:"GoldPath", en:"GoldPath" },
