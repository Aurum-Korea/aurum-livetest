      ...
      <div style={{ padding: isMobile ? '60px 20px' : '80px 80px', background: T.bg1, borderBottom: `1px solid ${T.border}` }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <div style={{ fontFamily: MONO, fontSize: 10, color: T.goldDim, letterSpacing: '0.22em', textTransform: 'uppercase', marginBottom: 12 }}>
              {ko ? '왜 실물 금인가' : 'Why Physical Gold'}
            </div>
            <div style={{ fontFamily: SERIF, fontStyle: 'italic', fontSize: isMobile ? 24 : 32, color: T.text }}>
              {ko ? '중앙은행이 사는 이유가 있습니다' : 'There\'s a reason central banks buy it'}
            </div>
          </div>
          {/* YouTube embed */}
          <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', border: `1px solid ${T.goldBorder}` }}>
            <iframe
              src="https://www.youtube.com/embed/d3_LN2VBQOE?rel=0&modestbranding=1&color=white"
              title={ko ? '실물 금 투자 가이드' : 'Physical Gold Investment Guide'}
