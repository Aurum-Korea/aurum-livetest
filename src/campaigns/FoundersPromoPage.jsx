        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          {SPOTS_REMAINING <= 0 ? (
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap', alignItems: 'stretch' }}>
              <button onClick={() => navigate('register')} style={{ background: T.gold, border: 'none', color: '#0d0b08', padding: '16px 36px', fontSize: 15, fontWeight: 700, cursor: 'pointer', fontFamily: T.sans, minWidth: 220 }}>
