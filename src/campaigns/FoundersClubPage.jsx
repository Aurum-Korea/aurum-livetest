  ...
  return (
    ...
    <div style={{ background:T.bgCard, border:`1px solid ${T.goldBorder}`, padding:'20px 18px', position:'relative', height:'100%', boxSizing:'border-box', display:'flex', flexDirection:'column', justifyContent:'center' }}>
      ...
      {GATES.map((g,i)=>{
        ...
        return (
          <div key={i} style={{ display:'flex', gap:8, alignItems:'center', marginBottom:i<4?10:0 }}>
            ...
            <div style={{ flex:1 }}>
              <div style={{ display:'flex', justifyContent:'space-between', marginBottom:3 }}>
                <span style={{ fontFamily:T.sans, fontSize:11, color:done?T.text:T.textMuted, whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' }}>{ko ? g.label : g.labelEn}</span>
            ...
            <span style={{ fontFamily:T.mono, fontSize:10, color:T.textMuted, flexShrink:0, minWidth:72, textAlign:'right' }}>₩{Math.round(g.gmv * krwRate / 1000000).toFixed(0)}M</span>
          </div>
        );
      })}
...
function LeaderboardWidget({ krwRate = 1375, lang = 'ko' }) {
  ...
  return (
    ...
    <div style={{ background:T.bgCard, border:`1px solid ${T.goldBorder}`, padding:'20px 18px', position:'relative', height:'100%', boxSizing:'border-box' }}>
      ...
      {[...LB].map((row,i)=>(
        <div key={i} style={{ display:'grid', gridTemplateColumns:'24px 1fr auto auto', gap:6, alignItems:'center', padding:'6px 0', borderBottom:i<LB.length-1?`1px solid rgba(197,165,114,0.06)`:'none' }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'24px 1fr auto auto', gap:6, alignItems:'center', padding:'6px 8px', marginTop:4, background:`linear-gradient(90deg,rgba(197,165,114,0.08),transparent)`, borderLeft:`2px solid ${T.gold}`, marginLeft:-18, paddingLeft:20 }}>
