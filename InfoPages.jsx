              ...
              {[
                <div key="gold">
                  ...
                  <div style={{ marginTop: 40, background: T.bgCard, border: `1px solid ${T.goldBorder}`, padding: '24px 28px', position: 'relative', overflow: 'hidden' }}>
                    <div style={GOLD_LINE} />
                    <div style={{ fontFamily: T.mono, fontSize: 11, color: T.goldDim, letterSpacing: '0.18em', textTransform: 'uppercase', marginBottom: 16 }}>MARKET FACTS · {MARKET_FACTS.lastVerified}</div>
                ...
                <div key="silver">
                  ...
                  <div style={{ marginTop: 40, background: T.bgCard, border: `1px solid ${T.goldBorder}`, padding: '24px 28px', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ fontFamily: T.mono, fontSize: 11, color: T.goldDim, letterSpacing: '0.18em', textTransform: 'uppercase', marginBottom: 16 }}>SILVER STATS · {MARKET_FACTS.lastVerified}</div>
      ...
      <div style={{ borderTop: `1px solid ${T.border}`, borderBottom: `1px solid ${T.border}` }}>
        <div className="aurum-container" style={{ paddingTop: isMobile ? 40 : 72, paddingBottom: isMobile ? 40 : 64 }}>
          <div className="reveal">
            <div style={{ fontFamily: T.mono, fontSize: 11, color: T.goldDim, letterSpacing: '0.18em', textTransform: 'uppercase', marginBottom: 10 }}>비교 분석</div>
        ...
        <div style={{ borderTop: `1px solid ${T.border}` }}>
          <div className="aurum-container" style={{ paddingTop: isMobile ? 40 : 64, paddingBottom: isMobile ? 40 : 64 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 28 }}>
              <span style={{ fontFamily: T.mono, fontSize: 11, color: T.gold, letterSpacing: '0.18em', textTransform: 'uppercase', border: `1px solid ${T.goldBorder}`, padding: '4px 10px' }}>{ko ? '시장 뉴스' : 'Market News'}</span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: 16 }}>
              {articles.slice(0, 3).map((a, i) => (
                <a key={i} href={a.link} target="_blank" rel="noopener noreferrer" style={{ background: T.bgCard, border: `1px solid ${T.goldBorder}`, padding: '20px 20px', display: 'block', textDecoration: 'none', transition: 'border-color 0.2s', position: 'relative', overflow: 'hidden' }}
                  ...
                  <div style={GOLD_LINE} />
                  <div style={{ fontFamily: T.mono, fontSize: 11, color: a.category === 'gold' ? T.gold : T.textMuted, letterSpacing: '0.14em', marginBottom: 10, textTransform: 'uppercase' }}>{a.source} · {a.category}</div>
  ...
  return (
    <div style={{ background: T.bg, minHeight: '80vh' }}>
      <div className="aurum-container" style={{ paddingTop: isMobile ? 40 : 60, paddingBottom: isMobile ? 40 : 72 }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          <div style={{ fontFamily: T.mono, fontSize: 11, color: T.goldDim, letterSpacing: '0.18em', marginBottom: 10, textTransform: 'uppercase' }}>AGP · 일일 백킹 리포트</div>
